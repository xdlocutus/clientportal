...
<div class="d-flex gap-2"><?php if ($ticket['status'] === 'open'): ?><a class="btn btn-primary" href="/modules/tickets/reply.php?id=<?= (int) $ticket['id'] ?>">Reply</a><?php if (!is_client_role()): ?><a class="btn btn-outline-danger" href="/modules/tickets/close.php?id=<?= (int) $ticket['id'] ?>" data-confirm="Close this ticket?">Close Ticket</a><?php endif; ?><?php endif; ?></div>
