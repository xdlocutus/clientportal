...
?>
<div class="d-flex justify-content-between align-items-center mb-3"><h1 class="h3 mb-0">Clients</h1><?php if (has_permission('clients.manage')): ?><a class="btn btn-primary" href="/modules/clients/add.php">Add Client</a><?php endif; ?></div>
<div class="card border-0 shadow-sm"><div class="table-responsive"><table class="table table-striped mb-0"><thead><tr><th>Company</th><th>Contact</th><th>Email</th><th>Phone</th><th>Tenant</th><th>Status</th><th></th></tr></thead><tbody><?php foreach ($clients as $client): ?><tr><td><?= h($client['company_name']) ?></td><td><?= h($client['contact_name']) ?></td><td><?= h($client['email']) ?></td><td><?= h($client['phone']) ?></td><td><?= h($client['tenant_name']) ?></td><td><?= invoice_status_badge($client['status']) ?></td><td class="text-end"><a class="btn btn-sm btn-outline-secondary" href="/modules/clients/view.php?id=<?= (int) $client['id'] ?>">View</a><?php if (has_permission('clients.manage')): ?> <a class="btn btn-sm btn-outline-primary" href="/modules/clients/edit.php?id=<?= (int) $client['id'] ?>">Edit</a> <a class="btn btn-sm btn-outline-danger" href="/modules/clients/delete.php?id=<?= (int) $client['id'] ?>" data-confirm="Delete this client?">Delete</a><?php endif; ?></td></tr><?php endforeach; ?></tbody></table></div></div>
